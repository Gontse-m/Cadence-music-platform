  ...
  return (
    <>
      ...
      <div className="pt-16">
        ...
        <section className="py-20 sm:py-28 md:py-32 px-4 sm:px-6 text-center text-white">
          <h1 className="font-mael text-4xl sm:text-5xl md:text-6xl font-bold mb-5 sm:mb-6 leading-tight [text-shadow:0_0_24px_#722F37,0_0_48px_#722F37,0_2px_6px_rgba(0,0,0,0.7)]">
            Music that pays<br />artists directly.
          </h1>
          <p className="text-base sm:text-lg md:text-xl max-w-xl mx-auto mb-8 sm:mb-10 [text-shadow:0_0_14px_#722F37,0_2px_4px_rgba(0,0,0,0.8)]">
        ...
        <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 max-w-5xl mx-auto">
          <h2 className="font-mael text-3xl sm:text-4xl font-bold text-center text-white mb-10 sm:mb-16 drop-shadow-lg">
            How Cadence works
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div
                key={step}
                className="text-center bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 sm:p-8 hover:bg-white/15 transition-colors"
              >
                <div className="text-mustard font-mael text-4xl sm:text-5xl font-bold mb-3 sm:mb-4 drop-shadow">{step}</div>
                <h3 className="font-mael text-lg sm:text-xl font-semibold text-white mb-2 drop-shadow">{title}</h3>
        ...
        <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center bg-burgundy/60 backdrop-blur-md border border-white/10 rounded-3xl px-6 sm:px-10 py-12 sm:py-16">
            <h2 className="font-mael text-3xl sm:text-4xl font-bold text-white mb-5 sm:mb-6 drop-shadow-lg">
              Built for independent artists
            </h2>
            <p className="text-white/85 text-base sm:text-lg max-w-2xl mx-auto mb-8 sm:mb-10 drop-shadow">
            ...
            <Link
              href="/upload"
              className="inline-block bg-mustard text-white px-8 py-3 rounded-full font-medium hover:bg-mustard-dark transition-colors"
            >
